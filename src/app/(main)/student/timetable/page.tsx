...
export default function StudentTimetablePage() {
  ...
  // In a real app, events would be fetched based on the current week
  // For this mock, we'll just use the MOCK_STUDENT_TIMETABLE for any week
  ...
  const calculateGridPosition = (event: TimetableEntry) => {
    ...
    const startRow = (startHour - 7) * 4 + (startMinute / 15) + 2; // +2 to account for header rows
